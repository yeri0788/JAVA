...
//  멤버 변수 : 특정한 연산이 없다면 대부분의 멤버변수는 string으로 
//	정의한다
	...
	public void showAnimal()
	{
		...
		System.out.println("동물의 성별는 : " + gender);
	}
	
	/*
	 부모클래스의 멤버가 private인 경우자식클래스에서 접근이 불가능하므로 
	 반드시 getter/setter 메서드를 통해 접근해야한다. 
	 getter : peivate 멤버를 반환할 때 사용 
	 setter : 값을 설정할때 사용
	 */
